  ...
  <div class="page-content-wrapper ">
    ...
    <script>
      function getCenterUserType(role) {
        ...
        var id = $("#center").val();
        // alert(id);
        getStudentListType(id, role);
        // getPendingListType(id, role);
        // getProcessedListType(id, role);
        getCounterType(id, 'all-count', role);
      }

      function getStudentListType(id, role) {
        $.ajax({
          url: '/app/centers/ledgers/student-wise/students?id=' + id + '&role=' + role,
          type: 'GET',
          success: function(data) {
      ...
      function getCounterType(id, status, role) {
        $.ajax({
          url: '/app/centers/ledgers/student-wise/students-counter?id=' + id + '&count_status=' + status + '&role=' + role,
          type: 'GET',
          success: function(data) {
            $("#all-counter").html(data);
          }
