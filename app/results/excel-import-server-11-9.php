...
// } 
        ...
        // ECHO "INSERT INTO `marksheets`(`enrollment_no`, `subject_id`, `obt_marks_ext`, `obt_marks_int`, `obt_marks`, `remarks`, `status`, `exam_month`,`exam_year`,`created_at`,`paper_code`) VALUES ('" . $enrollment . "', " . $subject_ids . ", " . $obt_ext_marks . ", $obt_int_marks, '" . $total . "', '" . $remarks . "',1, '" . $exam_month . "', '$exam_year','$created_at','" . $paper_code . "')";DIE;
