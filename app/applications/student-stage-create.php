...
?>
  ...
  <form role="form" id="form-oa-number" action="/app/applications/studnetStageStore" method="POST">
    <div class="modal-body">
      <div class="row clearfix">
        <div class="col-md-12">
          <div class="form-group form-group-default required">
            <label>Student Status</label>
            <select name="student_stage" id="student_stage" class="full-width " style="border: transparent;" >
                <?php 
                foreach ($student_stage as $key =>$value) { ?>
