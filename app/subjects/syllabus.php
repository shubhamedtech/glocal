...
?>
  ...
  $syllabus_query = $conn->query("SELECT Name,ID FROM Syllabi WHERE Sub_Course_ID = $sub_course_ids  AND Semester = '".$semesters."' $query");
      ...
      <div class="card info-box p-0">
        ...
        <div class="card-footer">
          <div class="row justify-content-between align-items-center">
            <?php 
                  $ebook_query = $conn->query("SELECT ID FROM e_books WHERE subject_id  = '" . $rows['ID'] . "'AND Course_ID='" . $_SESSION['Sub_Course_ID'] . "' AND e_books.status =1");
            ...
            <div class="col-md-4 text-center">
              <a href="/student/lms/subjects?id=<?= $rows['ID'] ?>&type=1&duration=<?=$semesters ?>"><i class="ti-book mr-2"></i><span><?=  $ebook_count ?></span></a>
            </div>
            <div class="col-md-4 text-center">
              <a href="/student/lms/subjects?id=<?= $rows['ID'] ?>&type=2&duration=<?=$semesters ?>"><i class="ti- ti-video-clapper mr-2"></i><span><?= $video_count ?></span></a>
            </div>
            <div class="col-md-4 text-center">
              <a href="/student/lms/subjects?id=<?= $rows['ID'] ?>&type=3&duration=<?=$semesters ?>"><i class=" ti-clipboard mr-2"></i><span>0</span></a>
            </div>
          </div>
        </div>
      </div>
