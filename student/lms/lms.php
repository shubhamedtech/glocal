                                ...
                                <div class="col-md-3">
                                    <div class="card info-box p-0">
                                        ...
                                        <div class="col-md-4 text-center">
                                            <a href="/student/lms/subjects?id=<?= $subResArr['ID'] ?>&type=1&duration=<?=$duration ?>"><i class="ti-book mr-2"></i><span><?= $ebook_count; ?></span></a>
                                        </div>
                                        <div class="col-md-4 text-center">
                                            <a href="/student/lms/subjects?id=<?= $subResArr['ID'] ?>&type=2&duration=<?=$duration ?>"><i class="ti- ti-video-clapper mr-2"></i><span><?= $video_count; ?></span></a>
                                        </div>
                                        <div class="col-md-4 text-center">
                                            <a href="/student/lms/subjects?id=<?= $subResArr['ID'] ?>&type=3&duration=<?=$duration ?>"><i class=" ti-clipboard mr-2"></i><span>0</span></a>
                                        </div>
                                    </div>
                                        </div>
                                    </div>
