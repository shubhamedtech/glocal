          ...
          var applicationSettings = {
            ...
            'columns': [{
                ...
                "render": function(data, type, row) {
                  var edit = row.Process_By_Center == 1 && (showInhouse || row.Step < 4) ? '<a href="/admissions/application-form?id=' + data + '"><i class="uil uil-edit mr-1" title="Edit Application Form"></i></a>' : row.Process_By_Center!=1 && role=='Administrator' ? '<a href="/admissions/application-form?id=' + data + '"><i class="uil uil-edit mr-1" title="Edit Application Form"></i></a>' : '';
