  ...
  <div class="page-content-wrapper ">
                      ...
                      <div class="row clearfix">
                        ...
                        <div class="col-md-4">
                          <div class="form-group form-group-default required">
                            <label>Center</label>
                            <select class="full-width" style="border: transparent;" data-init-plugin="select2" name="center" id="center" onchange="getAdmissionSession(); getCourse()">
    ...
    success: function(data) {
      ...
      function getAdmissionSession() {
          const universityId = '<?=$_SESSION['university_id']?>';
          const userId = $("#center").val();
        $.ajax({
