...
<div class="page-container ">
  ...
  <div class="page-content-wrapper ">
          ...
          var applicationSettings = {
            ...
            'columns': [{
              ...
              },
              {
                data: "Student_Stage",
                "render": function(data, type, row) {
                  var edit = showInhouse ? '<i class="uil uil-edit ml-2 cursor-pointer" title="Add Student Stage" onclick="addStuStage(&#39;' + row.ID + '&#39;)">' : '';
                  return data + edit;
                }
              },
              {
    ...
    <script type="text/javascript">
      ...
      function addStuStage(id){
        $.ajax({
          url: '/app/applications/student-stage-create?id=' + id,
          type: 'GET',
          success: function(data) {
            $('#md-modal-content').html(data);
            $('#mdmodal').modal('show');
