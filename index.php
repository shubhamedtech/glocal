    ...
    <div class="bg-pic" style="background-image: url('<?= $login_cover ?>'); background-repeat: no-repeat; background-size: cover;">
      ...
      <div class="bg-caption text-white m-b-20" style="padding: 200px;">
        <h1 class="semi-bold text-white">
          <img src="assets/img/university/1692276747.png" alt="">
        </h1>
        <p class="small">
          ...
          $.ajax({
            ...
            success: function(data) {
              if (data.status == 200) {
                ...
                $("#loginFormDom").html("");
                $("#loginFormDom").html('<h6 style="font-size: 13px;">OTP sent to your WhatsApp Number: '+data.number+'</h6>\
                <div class="form-group form-group-default">\
                  <label>OTP</label>\
                  <div class="controls">\
                ...
                <div class="row">\
                  <div class="col-md-12 d-flex align-items-center justify-content-end">\
                    <button aria-label="" class="btn btn-primary btn-lg m-t-10" type="button" onclick="verifyOTP()">Verify</button>\
                  </div>\
                </div>');   
                }
              } else {
